 ...
 */
public class AdapterPFisica extends ArrayAdapter<String> {
    private final Context context;
    private ArrayList<String> values = new ArrayList<>();
    private ArrayList<ItemPFisica> list = new ArrayList<>();
    View rowView;
    ...
    TextView addTel;
    TextView addEmail;
    public static EditText nome, cpf, tel,mail,cep, end, bairro, numero, compl;
    public static Spinner uf, city;

    public AdapterPFisica(Context context, ArrayList<String> values, ArrayList<ItemPFisica> list) {
        super(context, R.layout.item_list_pessoa_fisica, values);
    ...
    private void declarate() {
        ...
        cpf = (EditText)rowView.findViewById(R.id.cpf);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rowView = inflater.inflate(R.layout.item_list_pessoa_fisica, parent, false);
    ...
    private void masks() {
        MaskEditText maskCpf = new MaskEditText("###.###.###-##", cpf);
